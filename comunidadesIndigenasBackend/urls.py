...
urlpatterns = [
    ...
    path('asociacion/update/<int:pk>/',              views.AsociacionUpdateView.as_view()), 
    path('asociacion/remove/<int:pk>/',              views.AsociacionDeleteView.as_view()), 
    ...
    path('municipio/update/<int:pk>/',               views.MunicipioUpdateView.as_view()), 
    path('municipio/remove/<int:pk>/',               views.MunicipioDeleteView.as_view()), 
    ...
    path('departamento/update/<int:pk>/',            views.DepartamentoUpdateView.as_view()), 
    path('departamento/remove/<int:pk>/',            views.DepartamentoDeleteView.as_view()), 
    ...
    path('resguardo/update/<int:pk>/',               views.ResguardoUpdateView.as_view()), 
    path('resguardo/remove/<int:pk>/',               views.ResguardoDeleteView.as_view()), 
